# Generated by Django 3.1.7 on 2021-11-17 02:40
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_ajuste', models.DateTimeField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_eliminacion', models.DateField(blank=True, null=True)),
                ('user_updated_id', models.IntegerField(blank=True, null=True)),
                ('ultimo_metraje', models.FloatField(blank=True, null=True)),
                ('metraje_deposito', models.FloatField()),
                ('metraje_ajustado', models.FloatField(blank=True, null=True)),
                ('monto_perdida', models.IntegerField(blank=True, default=0, null=True)),
